...
namespace WcfITPortugal
{



    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "Service1" in code, svc and config file together.
    public class ServicePortugal: IServicePortugal
    {

        PortugalEntities db = new PortugalEntities();
        ...
        public int AddAnuncioModel(AnuncioModel procura)
        {
            ...
            WcfITPortugal.anuncio anuncio = new WcfITPortugal.anuncio();
        ...
        public bool AddDescricao(DescricaoModel desc)
        {
            ...
            WcfITPortugal.anunciodesc proc = new WcfITPortugal.anunciodesc();
        ...
        public int AddEmpresa(EmpresaModel desc)
        {
            ...
            WcfITPortugal.empresa proc = new WcfITPortugal.empresa();
