...
namespace MvcTIC_IT.Libraries
{
    public class settings
    {
        ...
        public string logoES = "G:/logosES/";
        public string logoFR = "G:/logosFR/";
        public string logoUK = "G:/logosUK/";
        public string logoDE = "G:/logosDE/";
        public string logoWW = "G:/logosWW/";
    ...
    public class Utils
    {
        ...
        public static bool sendSimpleEmail(string toEmail, string utilizador, string fromEmail, string subjectEmail, string bodyEmail)
        {
            try
            {
                ...
                mail.Body += "Mensagem enviada por Dinispt.com.";
