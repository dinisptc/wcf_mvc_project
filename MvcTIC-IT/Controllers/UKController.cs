...
{
    public class UKController : BaseController
    {
        //
        // GET: /Portugal/

        ServiceRefUK.ServiceUKClient proxy = new ServiceRefUK.ServiceUKClient();
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefUK.PortugalViewModel> products = proxy.GetAllAnunciosID(RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefUK.PortugalViewModel> productPage = products.ToPagedList(page, 10);
            ...
            //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel model = new ServiceRefPortugal.PortugalViewModel();
                MvcTIC_IT.ServiceRefUK.PortugalViewModel model = new ServiceRefUK.PortugalViewModel();
        ...
        public ActionResult IndexMeuAdmin(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefUK.PortugalViewModel> products = proxy.GetAnunciosIndexByIdentidade(User.Identity.Name, RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefUK.PortugalViewModel> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult CriarOferta(MvcTIC_IT.ViewModels.PortugalViewModel collection)
        {
            ...
            try
            {
                ...
                MvcTIC_IT.ServiceRefUK.AnuncioModel pproc = new MvcTIC_IT.ServiceRefUK.AnuncioModel();
                ...
                MvcTIC_IT.ServiceRefUK.DescricaoModel desmo = new MvcTIC_IT.ServiceRefUK.DescricaoModel();
        ...
        public ActionResult Detalhes(int id)
        {
            ...
            MvcTIC_IT.ServiceRefUK.PortugalViewModel oi = new MvcTIC_IT.ServiceRefUK.PortugalViewModel();
            oi.id = i.id;
            oi.email = i.email;            
        ...
        {
            return new ThumbImoveisResultUK(id);
        }
        ...
        public ActionResult Edit(int id, MvcTIC_IT.ViewModels.PortugalViewModel collection, string hidden_field_id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefUK.DescricaoModel pprocdesc = new MvcTIC_IT.ServiceRefUK.DescricaoModel();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Pesquisa(MvcTIC_IT.ServiceRefUK.SearchPortugalViewModel collection, int page = 1)
        {
            ...
            try
            {
                string lang = RouteData.Values["lang"].ToString();
                int idiomacode = proxy.GetIdioma_ID(lang);
                List<MvcTIC_IT.ServiceRefUK.SearchPortugalViewModel> index = proxy.Search(collection, idiomacode).ToList();
                IPagedList<MvcTIC_IT.ServiceRefUK.SearchPortugalViewModel> productPage = index.ToPagedList(page, 10);
