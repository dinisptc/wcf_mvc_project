...
{
    public class EmpresaDEController : BaseController
    {
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefAlemanha.empresa> products = proxy.GetEmpresasIndexByIdentidade(User.Identity.Name).ToList();
            IPagedList<MvcTIC_IT.ServiceRefAlemanha.empresa> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            MvcTIC_IT.ServiceRefAlemanha.empresa empresa = proxy.GetEmpresaIndexByID(id);
            if (empresa == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create(MvcTIC_IT.ViewModels.EmpresaViewmodel empresa)
        {
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefAlemanha.EmpresaModel pproc = new MvcTIC_IT.ServiceRefAlemanha.EmpresaModel();
        ...
        {
            //empresa empresa = db.empresa.Single(e => e.id == id);
            MvcTIC_IT.ServiceRefAlemanha.empresa emp = proxy.GetEmpresaIndexByID(id);
            if (emp == null)
            {
                return HttpNotFound();
            }
        ...
        [Authorize(Roles = "admin,user")]
        [ValidateInput(false)]
        public ActionResult InsereFotos(MvcTIC_IT.ServiceRefAlemanha.empresa cat)
        {
            ViewData["idi"] = cat.id;
