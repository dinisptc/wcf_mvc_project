...
{
    public class AlemanhaController : BaseController
    {
        //
        // GET: /Portugal/

        ServiceRefAlemanha.ServiceAlemanhaClient proxy = new ServiceRefAlemanha.ServiceAlemanhaClient();
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel> products = proxy.GetAllAnunciosID(RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel> productPage = products.ToPagedList(page, 10);
            ...
            //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel model = new ServiceRefPortugal.PortugalViewModel();
                MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel model = new ServiceRefAlemanha.PortugalViewModel();
        ...
        public ActionResult IndexMeuAdmin(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel> products = proxy.GetAnunciosIndexByIdentidade(User.Identity.Name, RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult CriarOferta(MvcTIC_IT.ViewModels.PortugalViewModel collection)
        {
            ...
            try
            {
                ...
                MvcTIC_IT.ServiceRefAlemanha.AnuncioModel pproc = new MvcTIC_IT.ServiceRefAlemanha.AnuncioModel();
                ...
                MvcTIC_IT.ServiceRefAlemanha.DescricaoModel desmo = new MvcTIC_IT.ServiceRefAlemanha.DescricaoModel();
        ...
        public ActionResult Detalhes(int id)
        {
            ...
            MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel oi = new MvcTIC_IT.ServiceRefAlemanha.PortugalViewModel();
            oi.id = i.id;
            oi.email = i.email;            
        ...
        {
            return new ThumbImoveisResultDE(id);
        }
        ...
        public ActionResult Edit(int id, MvcTIC_IT.ViewModels.PortugalViewModel collection, string hidden_field_id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefAlemanha.DescricaoModel pprocdesc = new MvcTIC_IT.ServiceRefAlemanha.DescricaoModel();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Pesquisa(MvcTIC_IT.ServiceRefAlemanha.SearchPortugalViewModel collection, int page = 1)
        {
            ...
            try
            {
                string lang = RouteData.Values["lang"].ToString();
                int idiomacode = proxy.GetIdioma_ID(lang);
                List<MvcTIC_IT.ServiceRefAlemanha.SearchPortugalViewModel> index = proxy.Search(collection, idiomacode).ToList();
                IPagedList<MvcTIC_IT.ServiceRefAlemanha.SearchPortugalViewModel> productPage = index.ToPagedList(page, 10);
