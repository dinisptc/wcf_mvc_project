...
{
    public class EmpresaESController : BaseController
    {
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefEspanha.empresa> products = proxy.GetEmpresasIndexByIdentidade(User.Identity.Name).ToList();
            IPagedList<MvcTIC_IT.ServiceRefEspanha.empresa> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            MvcTIC_IT.ServiceRefEspanha.empresa empresa = proxy.GetEmpresaIndexByID(id);
            if (empresa == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create(MvcTIC_IT.ViewModels.EmpresaViewmodel empresa)
        {
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefEspanha.EmpresaModel pproc = new MvcTIC_IT.ServiceRefEspanha.EmpresaModel();
        ...
        {
            //empresa empresa = db.empresa.Single(e => e.id == id);
            MvcTIC_IT.ServiceRefEspanha.empresa emp = proxy.GetEmpresaIndexByID(id);
            if (emp == null)
            {
                return HttpNotFound();
            }
        ...
        [Authorize(Roles = "admin,user")]
        [ValidateInput(false)]
        public ActionResult InsereFotos(MvcTIC_IT.ServiceRefEspanha.empresa cat)
        {
            ViewData["idi"] = cat.id;
