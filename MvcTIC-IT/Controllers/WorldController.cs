...
namespace MvcTIC_IT.Controllers
{
    public class WorldController : BaseController
    {
        ...
        ServiceRefWorld.ServiceWorldClient proxy = new ServiceRefWorld.ServiceWorldClient();
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefWorld.PortugalViewModel> products = proxy.GetAllAnunciosID(RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefWorld.PortugalViewModel> productPage = products.ToPagedList(page, 10);
            ...
            //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel model = new ServiceRefPortugal.PortugalViewModel();
                MvcTIC_IT.ServiceRefWorld.PortugalViewModel model = new ServiceRefWorld.PortugalViewModel();
        ...
        public ActionResult IndexMeuAdmin(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefWorld.PortugalViewModel> products = proxy.GetAnunciosIndexByIdentidade(User.Identity.Name, RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefWorld.PortugalViewModel> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult CriarOferta(MvcTIC_IT.ViewModels.PortugalViewModel collection)
        {
            ...
            try
            {
                ...
                MvcTIC_IT.ServiceRefWorld.AnuncioModel pproc = new MvcTIC_IT.ServiceRefWorld.AnuncioModel();
                ...
                MvcTIC_IT.ServiceRefWorld.DescricaoModel desmo = new MvcTIC_IT.ServiceRefWorld.DescricaoModel();
        ...
        public ActionResult Detalhes(int id)
        {
            ...
            MvcTIC_IT.ServiceRefWorld.PortugalViewModel oi = new MvcTIC_IT.ServiceRefWorld.PortugalViewModel();
            oi.id = i.id;
            oi.email = i.email;            
        ...
        {
            return new ThumbImoveisResultWW(id);
        }
        ...
        public ActionResult Edit(int id, MvcTIC_IT.ViewModels.PortugalViewModel collection, string hidden_field_id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefWorld.DescricaoModel pprocdesc = new MvcTIC_IT.ServiceRefWorld.DescricaoModel();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Pesquisa(MvcTIC_IT.ServiceRefWorld.SearchPortugalViewModel collection, int page = 1)
        {
            ...
            try
            {
                string lang = RouteData.Values["lang"].ToString();
                int idiomacode = proxy.GetIdioma_ID(lang);
                List<MvcTIC_IT.ServiceRefWorld.SearchPortugalViewModel> index = proxy.Search(collection, idiomacode).ToList();
                IPagedList<MvcTIC_IT.ServiceRefWorld.SearchPortugalViewModel> productPage = index.ToPagedList(page, 10);
