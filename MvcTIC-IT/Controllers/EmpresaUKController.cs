...
{
    public class EmpresaUKController : BaseController
    {
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefUK.empresa> products = proxy.GetEmpresasIndexByIdentidade(User.Identity.Name).ToList();
            IPagedList<MvcTIC_IT.ServiceRefUK.empresa> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            MvcTIC_IT.ServiceRefUK.empresa empresa = proxy.GetEmpresaIndexByID(id);
            if (empresa == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create(MvcTIC_IT.ViewModels.EmpresaViewmodel empresa)
        {
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefUK.EmpresaModel pproc = new MvcTIC_IT.ServiceRefUK.EmpresaModel();
        ...
        {
            //empresa empresa = db.empresa.Single(e => e.id == id);
            MvcTIC_IT.ServiceRefUK.empresa emp = proxy.GetEmpresaIndexByID(id);
            if (emp == null)
            {
                return HttpNotFound();
            }
        ...
        [Authorize(Roles = "admin,user")]
        [ValidateInput(false)]
        public ActionResult InsereFotos(MvcTIC_IT.ServiceRefUK.empresa cat)
        {
            ViewData["idi"] = cat.id;
