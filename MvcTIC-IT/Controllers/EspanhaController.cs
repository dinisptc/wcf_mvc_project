...
{
    public class EspanhaController : BaseController
    {
        //
        // GET: /Portugal/

        ServiceRefEspanha.ServiceEspanhaClient proxy = new ServiceRefEspanha.ServiceEspanhaClient();
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefEspanha.PortugalViewModel> products = proxy.GetAllAnunciosID(RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefEspanha.PortugalViewModel> productPage = products.ToPagedList(page, 10);
            ...
            //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel model = new ServiceRefPortugal.PortugalViewModel();
                MvcTIC_IT.ServiceRefEspanha.PortugalViewModel model = new ServiceRefEspanha.PortugalViewModel();
        ...
        public ActionResult IndexMeuAdmin(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefEspanha.PortugalViewModel> products = proxy.GetAnunciosIndexByIdentidade(User.Identity.Name, RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefEspanha.PortugalViewModel> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult CriarOferta(MvcTIC_IT.ViewModels.PortugalViewModel collection)
        {
            ...
            try
            {
                ...
                MvcTIC_IT.ServiceRefEspanha.AnuncioModel pproc = new MvcTIC_IT.ServiceRefEspanha.AnuncioModel();
                ...
                MvcTIC_IT.ServiceRefEspanha.DescricaoModel desmo = new MvcTIC_IT.ServiceRefEspanha.DescricaoModel();
        ...
        public ActionResult Detalhes(int id)
        {
            ...
            MvcTIC_IT.ServiceRefEspanha.PortugalViewModel oi = new MvcTIC_IT.ServiceRefEspanha.PortugalViewModel();
            oi.id = i.id;
            oi.email = i.email;            
        ...
        {
            return new ThumbImoveisResultES(id);
        }
        ...
        public ActionResult Edit(int id, MvcTIC_IT.ViewModels.PortugalViewModel collection, string hidden_field_id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefEspanha.DescricaoModel pprocdesc = new MvcTIC_IT.ServiceRefEspanha.DescricaoModel();
        ...
        public ActionResult Globalizar(int id)
        {
            ...
            else
            {
                ...
                //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel procview = new MvcTIC_IT.ServiceRefPortugal.PortugalViewModel();
                 PortugalViewModel procview = new PortugalViewModel();
                 if (desc == null)
                 {
        ...
        [Authorize(Roles = "user,admin")]
        [ValidateInput(false)]
        public ActionResult Globalizar(int id, PortugalViewModel collection)
        {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Pesquisa(MvcTIC_IT.ServiceRefEspanha.SearchPortugalViewModel collection, int page = 1)
        {
            ...
            try
            {
                string lang = RouteData.Values["lang"].ToString();
                int idiomacode = proxy.GetIdioma_ID(lang);
                List<MvcTIC_IT.ServiceRefEspanha.SearchPortugalViewModel> index = proxy.Search(collection, idiomacode).ToList();
                IPagedList<MvcTIC_IT.ServiceRefEspanha.SearchPortugalViewModel> productPage = index.ToPagedList(page, 10);
