...
{
    public class FranceController : BaseController
    {
        //
        // GET: /Portugal/

        ServiceRefFrance.ServiceFranceClient proxy = new ServiceRefFrance.ServiceFranceClient();
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefFrance.PortugalViewModel> products = proxy.GetAllAnunciosID(RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefFrance.PortugalViewModel> productPage = products.ToPagedList(page, 10);
            ...
            //MvcTIC_IT.ServiceRefPortugal.PortugalViewModel model = new ServiceRefPortugal.PortugalViewModel();
                MvcTIC_IT.ServiceRefFrance.PortugalViewModel model = new ServiceRefFrance.PortugalViewModel();
        ...
        public ActionResult IndexMeuAdmin(int page = 1)
        {
            ...
            List<MvcTIC_IT.ServiceRefFrance.PortugalViewModel> products = proxy.GetAnunciosIndexByIdentidade(User.Identity.Name, RouteData.Values["lang"].ToString()).ToList();
            IPagedList<MvcTIC_IT.ServiceRefFrance.PortugalViewModel> productPage = products.ToPagedList(page, 10);
        ...
        public ActionResult CriarOferta(MvcTIC_IT.ViewModels.PortugalViewModel collection)
        {
            ...
            try
            {
                ...
                MvcTIC_IT.ServiceRefFrance.AnuncioModel pproc = new MvcTIC_IT.ServiceRefFrance.AnuncioModel();
                ...
                MvcTIC_IT.ServiceRefFrance.DescricaoModel desmo = new MvcTIC_IT.ServiceRefFrance.DescricaoModel();
        ...
        public ActionResult Detalhes(int id)
        {
            ...
            MvcTIC_IT.ServiceRefFrance.PortugalViewModel oi = new MvcTIC_IT.ServiceRefFrance.PortugalViewModel();
            oi.id = i.id;
            oi.email = i.email;            
        ...
        {
            return new ThumbImoveisResultFR(id);
        }
        ...
        public ActionResult Edit(int id, MvcTIC_IT.ViewModels.PortugalViewModel collection, string hidden_field_id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                MvcTIC_IT.ServiceRefFrance.DescricaoModel pprocdesc = new MvcTIC_IT.ServiceRefFrance.DescricaoModel();
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult Pesquisa(MvcTIC_IT.ServiceRefFrance.SearchPortugalViewModel collection, int page = 1)
        {
            ...
            try
            {
                string lang = RouteData.Values["lang"].ToString();
                int idiomacode = proxy.GetIdioma_ID(lang);
                List<MvcTIC_IT.ServiceRefFrance.SearchPortugalViewModel> index = proxy.Search(collection, idiomacode).ToList();
                IPagedList<MvcTIC_IT.ServiceRefFrance.SearchPortugalViewModel> productPage = index.ToPagedList(page, 10);
